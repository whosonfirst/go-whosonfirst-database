...
func (t *NamesTable) IndexRecord(ctx context.Context, tx *sql.Tx, i interface{}) error {
	return t.IndexFeature(ctx, tx, i.([]byte))
}

func (t *NamesTable) IndexFeature(ctx context.Context, tx *sql.Tx, f []byte) error {
