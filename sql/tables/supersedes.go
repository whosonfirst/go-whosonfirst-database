...
func (t *SupersedesTable) IndexRecord(ctx context.Context, tx *sql.Tx, i interface{}) error {
	return t.IndexFeature(ctx, tx, i.([]byte))
}

func (t *SupersedesTable) IndexFeature(ctx context.Context, tx *sql.Tx, f []byte) error {
