...
// StandardPlacesResult is a struct that implements the `whosonfirst/go-whosonfirst-spr.StandardPlacesResult`
// interface for records stored in a  database and which have been indexed by the `whosonfirst/go-whosonfirst-sqlite-features`
// package.
